...
class Functions:
    ...
    def res_hook(self, res, *args, **kwargs):
        ...
        log_str = \
            "{} -- HTTP Connection with : '{}' resulted in a status code of '{}'".format(datetime.now().strftime("%H:%M:%S"
    ...
    def cf_download(self, scraper, title, zero, pages, ext, base):
        for i in range(1, pages + 1):
            ...
            folder_path = const.DOWNLOAD_PATH + re.sub(r"[\\/:*?\"<>|]"
                    , "", title)
